...
/**
 * _strncmp - havu function compare two strings
 * @s1: the first string
...
/**
 * _close - H.function close a file descriptor and print an error on failure
...
/**
 * _read - H.function read from a file and print an error message upon failure
...
/**
 * elf_magic - havu function print ELF magic
...
/**
 * elf_class - havu function print ELF class
 * @buffer: the ELF header
 *
...
/**
 * elf_data - havu function print ELF data
 * @buffer: the ELF header
 *
...
/**
 * elf_version - havu function print ELF version
 * @buffer: the ELF header
 */
...
/**
 * elf_osabi - havu function print ELF OS/ABI
 * @buffer: the ELF header
 */
...
/**
 * elf_abivers - havu function print ELF ABI version
 * @buffer: the ELF header
 */
...
/**
 * elf_type - havu function print ELF type
 * @buffer: the ELF header
...
/**
 * elf_entry - havu function print entry point address
...
/**
 * main - havu function copy a file's contents to another file
